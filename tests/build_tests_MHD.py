...
for  nnn  in range(0,len(Nchoices)):
  ...
  #============================================================================
  #============================================================================
  #first group  MHD standardDG 100 < caseID <200
  #============================================================================
  #============================================================================
  caseID=baseID+100 
  baseopts=[
  ...
  if(cases[0] ==0 or (caseID in cases)) :
     pname="build_"+EQNchoice+"_stdDG_N_"+Nchoice+"_noGLM_nopara"
  ...
  caseID=caseID+1
  if(cases[0] ==0 or (caseID in cases)) :
     pname="build_"+EQNchoice+"_stdDG_N_"+Nchoice+"_GLM_para_cons_var"
     print( "caseID: %d name: %s" % (caseID,pname) )
  ...
  #============================================================================
  #============================================================================
  #next group  MHD splitDG noGLM no NONCONS 200 < caseID <300
  #============================================================================
  #============================================================================
  caseID=baseID+200 
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_noGLM_noNONCONS_volFlux_"+volflux+"_nopara"
       print( "caseID: %d name: %s" % (caseID,pname) )
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_noGLM_noNONCONS_volFlux_"+volflux+"_para_cons_var"
       print( "caseID: %d name: %s" % (caseID,pname) )
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_noGLM_noNONCONS_volFlux_"+volflux+"_para_entropy_var"
       print( "caseID: %d name: %s" % (caseID,pname) )
  ...
  #============================================================================
  #============================================================================
  #next group  MHD splitDG noGLM NONCONS 300 < caseID <400
  #============================================================================
  #============================================================================
  caseID=baseID+300 
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_noGLM_NONCONSpow_volflux_"+volflux+"_nopara"
       print( "caseID: %d name: %s" % (caseID,pname) )
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_noGLM_NONCONSbrack_volflux_"+volflux+"_nopara"
       print( "caseID: %d name: %s" % (caseID,pname) )
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_noGLM_NONCONSjan_volflux_"+volflux+"_nopara"
       print( "caseID: %d name: %s" % (caseID,pname) )
       ...
       options.extend([
                 "FLUXO_PARABOLIC"        ,"OFF"
                ,"FLUXO_EQN_VOLFLUX"      ,volflux
                ,"FLUXO_EQN_NONCONS_TYPE" ,"Janhunen"
               ])
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_noGLM_NONCONSbrack_volFlux_"+volflux+"_para_cons_var"
       print( "caseID: %d name: %s" % (caseID,pname) )
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_noGLM_NONCONSbrack_volFlux_"+volflux+"_para_entropy_var"
       print( "caseID: %d name: %s" % (caseID,pname) )
  ...
  #============================================================================
  #============================================================================
  #next group  MHD splitDG GLM no NONCONS 400 < caseID <500
  #============================================================================
  #============================================================================
  caseID=baseID+400 
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_noNONCONS_volFlux_"+volflux+"_nopara"
       print( "caseID: %d name: %s" % (caseID,pname) )
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_noNONCONS_volFlux_"+volflux+"_para_cons_var"
       print( "caseID: %d name: %s" % (caseID,pname) )
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_noNONCONS_volFlux_"+volflux+"_para_entropy_var"
       print( "caseID: %d name: %s" % (caseID,pname) )
  ...
  #============================================================================
  #============================================================================
  #next group  MHD splitDG GLM NONCONS 500 < caseID <600
  #============================================================================
  #============================================================================
  caseID=baseID+500 
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_NONCONSpow_volFlux_"+volflux+"_nopara"
       print( "caseID: %d name: %s" % (caseID,pname) )
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_NONCONSbrack_volFlux_"+volflux+"_nopara"
       print( "caseID: %d name: %s" % (caseID,pname) )
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_NONCONSjan_volFlux_"+volflux+"_nopara"
       print( "caseID: %d name: %s" % (caseID,pname) )
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_NONCONSpow_volFlux_"+volflux+"_para_cons_var"
       print( "caseID: %d name: %s" % (caseID,pname) )
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_NONCONSpow_volFlux_"+volflux+"_para_entropy_var"
       print( "caseID: %d name: %s" % (caseID,pname) )

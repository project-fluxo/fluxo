...
def job_definition():
   ...
   jobs['mhd_split_glm_noncons_nopara_p4est_SC']={
          'case': caseID ,
          'tags': ['mhd','split-form','SC','GL','GLM','NONCONS','p4est','amr','residuals'] ,
          'build_opts':{**baseopts,
                        'FLUXO_DISCTYPE'         :'2',
                        'FLUXO_DISC_NODETYPE'    :'GAUSS-LOBATTO',
                        'FLUXO_EQN_GLM'          :'ON',
   ...
   jobs['mhd_split_glm_noncons_br1_p4est_SC']={
          'case': caseID ,
          'tags': ['mhd','split-form','SC','GL','GLM','NONCONS','p4est','amr','br1','residuals'] ,
          'build_opts':{**baseopts,
                        'FLUXO_DISCTYPE'         :'2',
                        'FLUXO_DISC_NODETYPE'    :'GAUSS-LOBATTO',
                        'FLUXO_EQN_GLM'          :'ON',
   ...
   jobs['build_navierstokes_type2_SC_br2_entr_vars']={
          'case': caseID,
          'tags': [ 'navierstokes','split-form','GL','br2','entropy_var','nonconforming','SC','residuals'],
          'build_opts':{**baseopts,
                        'FLUXO_DISCTYPE'         :'2',
                        "FLUXO_DISC_NODETYPE"    :"GAUSS-LOBATTO",
                        "FLUXO_PARABOLIC"        :"ON",

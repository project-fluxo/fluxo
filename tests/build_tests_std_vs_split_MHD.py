...
for  nnn  in range(0,len(Nchoices)):
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_noGLM_NONCONS_volFlux_"+volflux+"_para_cons_var"
       print( "caseID: %d name: %s" % (caseID,pname) )
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_noGLM_NONCONS_volFlux_"+volflux+"_para_entropy_var"
       print( "caseID: %d name: %s" % (caseID,pname) )
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_NONCONS_volFlux_"+volflux+"_nopara"
       print( "caseID: %d name: %s" % (caseID,pname) )
  ...
  for  vvv  in range(0,len(volfluxes)):
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_NONCONS_volFlux_"+volflux+"_para_cons_var"
       print( "caseID: %d name: %s" % (caseID,pname) )
    ...
    caseID=caseID+1
    if(cases[0] ==0 or (caseID in cases)) :
       pname="build_"+EQNchoice+"_splitDG_N_"+Nchoice+"_GLM_NONCONS_volFlux_"+volflux+"_para_entropy_var"
       print( "caseID: %d name: %s" % (caseID,pname) )

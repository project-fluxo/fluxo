...
!===================================================================================================================================
SUBROUTINE Lifting_FillFlux(Uface_master,Uface_slave,FluxX,FluxY,FluxZ,doMPISides)
! MODULES
USE MOD_PreProc
...
REAL,INTENT(IN)    :: Uface_master(PP_nVar,0:PP_N,0:PP_N,1:nSides)
REAL,INTENT(IN)    :: Uface_slave(PP_nVar,0:PP_N,0:PP_N,1:nSides)
!-----------------------------------------------------------------------------------------------------------------------------------
! OUTPUT VARIABLES
...
DO SideID = firstSideID,lastSideID
  ...
  DO q=0,PP_N; DO p=0,PP_N
    !Flux(:,p,q,SideID)=0.5*(Uface_master(:,p,q,SideID)+Uface_slave( :,p,q,SideID))*NormVec(dir,p,q,SideID)*SurfElem(p,q,SideID)
    !BR2, 1/2(UR+UL)-UL=1/2(UR-UL)
    F_loc(:)=0.5*(Uface_slave(:,p,q,SideID)-Uface_master( :,p,q,SideID))*SurfElem(p,q,SideID)

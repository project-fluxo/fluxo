...
"name of the testcase that is supposed to be used in simulation. Check if its = current testcase.","taylorgreeenvortex")
...
whichTestcase = GETSTR('whichTestcase','taylorgreenvortex')

IF(INDEX(TRIM(WhichTestcase),'taylorgreenvortex').EQ.0)THEN
CALL abort(__STAMP__,&
"compiled with testcase taylorgreenvortex, but specified testcase is : "//TRIM(whichTestcase))
END IF

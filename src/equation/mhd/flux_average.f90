...
DO k=0,PP_N; DO j=0,PP_N; DO i=0,PP_N
  ...
  Phi_MHD_s4(vs:ve) = 0.25 * (/U_in(IB1:IB3,i,j,k),Uaux(IVB,i,j,k),Uaux(IU:IW,i,j,k)/)
#elif NONCONS==2 /*Brackbill*/
  ! Brackbill: Phi(IRHOU:IRHOW) =B
  Phi_MHD_s4(vs:ve) = 0.25 * U_in(IB1:IB3,i,j,k)
#elif NONCONS==3 /*Janhunen*/
  ! Janhunen: Phi(IB1:IB3) =v
  Phi_MHD_s4(vs:ve) = 0.25 * Uaux(IU:IW,i,j,k)
#endif /*NONCONSTYPE*/
  ...
  DO l=0,PP_N
    f(vs:ve,l,i,j,k) = f(vs:ve,l,i,j,k) + Phi_MHD_s4 * dot_product(M_f(:,i,j,k)+M_f(:,l,j,k),U_in(IB1:IB3,i,j,k)+U_in(IB1:IB3,l,j,k))
#if defined(PP_GLM) && defined (PP_NC_GLM)
  ...
  DO l=0,PP_N
    g(vs:ve,l,i,j,k) = g(vs:ve,l,i,j,k) + Phi_MHD_s4 * dot_product(M_g(:,i,j,k)+M_g(:,i,l,k),U_in(IB1:IB3,i,j,k)+U_in(IB1:IB3,i,l,k))
#if defined(PP_GLM) && defined (PP_NC_GLM)
    !nonconservative term to restore Galilean invariance for GLM term
  ...
  DO l=0,PP_N
    h(vs:ve,l,i,j,k) = h(vs:ve,l,i,j,k) + Phi_MHD_s4 * dot_product(M_h(:,i,j,k)+M_h(:,i,j,l),U_in(IB1:IB3,i,j,k)+U_in(IB1:IB3,i,j,l))
#if defined(PP_GLM) && defined (PP_NC_GLM)
    !nonconservative term to restore Galilean invariance for GLM term
...
DO k=0,PP_N; DO j=0,PP_N; DO i=0,PP_N
...
#if NONCONS==1 /*Powell*/
  ! Powell: Phi(IRHOU:IB3) =B,vB,v
  phi(vs:ve,1,1,i,j,k) = 0.25 * (/U_in(IB1:IB3,i,j,k),Uaux(IVB,i,j,k),Uaux(IU:IW,i,j,k)/)
#elif NONCONS==2 /*Brackbill*/
  ! Brackbill: Phi(IRHOU:IRHOW) =B
  phi(vs:ve,1,1,i,j,k) = 0.25 * U_in(IB1:IB3,i,j,k)
#elif NONCONS==3 /*Janhunen*/
  ! Janhunen: Phi(IB1:IB3) =v
  phi(vs:ve,1,1,i,j,k) = 0.25 * Uaux(IU:IW,i,j,k)
#endif /*NONCONSTYPE*/
  ...
  !-----------------------------
#if defined(PP_GLM) && defined (PP_NC_GLM)
  phi((/IRHOE,IPSI/),1,2,i,j,k) = 0.5*SUM(M_f(:,i,j,k)*Uaux(IU:IW,i,j,k)) *(/U_in(IPSI,i,j,k),1./)
#endif /*PP_GLM and PP_NC_GLM*/
  
  DO l=0,PP_N
    f(1,l,i,j,k) = dot_product(M_f(:,i,j,k)+M_f(:,l,j,k),U_in(IB1:IB3,i,j,k)+U_in(IB1:IB3,l,j,k))
#if defined(PP_GLM) && defined (PP_NC_GLM)
    !nonconservative term to restore Galilean invariance for GLM term
    f(2,l,i,j,k) = U_in(IPSI,i,j,k)+U_in(IPSI,l,j,k)
#endif /*PP_GLM and PP_NC_GLM*/
  END DO !l=0,PP_N
  ...
  !------------------------------
#if defined(PP_GLM) && defined (PP_NC_GLM)
  phi((/IRHOE,IPSI/),2,2,i,j,k) = 0.5*SUM(M_g(:,i,j,k)*Uaux(IU:IW,i,j,k)) *(/U_in(IPSI,i,j,k),1./)
#endif /*PP_GLM and PP_NC_GLM*/
  
  DO l=0,PP_N
    g(1,l,i,j,k) = dot_product(M_g(:,i,j,k)+M_g(:,i,l,k),U_in(IB1:IB3,i,j,k)+U_in(IB1:IB3,i,l,k))
#if defined(PP_GLM) && defined (PP_NC_GLM)
    !nonconservative term to restore Galilean invariance for GLM term
    g(2,l,i,j,k) = U_in(IPSI,i,j,k)+U_in(IPSI,i,l,k)
#endif /*PP_GLM and PP_NC_GLM*/
  END DO !l=0,PP_N
  ...
  !-------------------------------
#if defined(PP_GLM) && defined (PP_NC_GLM)
  phi((/IRHOE,IPSI/),3,2,i,j,k) = 0.5*SUM(M_h(:,i,j,k)*Uaux(IU:IW,i,j,k)) *(/U_in(IPSI,i,j,k),1./)
#endif /*PP_GLM and PP_NC_GLM*/
  
  DO l=0,PP_N
    h(1,l,i,j,k) = dot_product(M_h(:,i,j,k)+M_h(:,i,j,l),U_in(IB1:IB3,i,j,k)+U_in(IB1:IB3,i,j,l))
#if defined(PP_GLM) && defined (PP_NC_GLM)
    !nonconservative term to restore Galilean invariance for GLM term
    h(2,l,i,j,k) = U_in(IPSI,i,j,k)+U_in(IPSI,i,j,l)
#endif /*PP_GLM and PP_NC_GLM*/
  END DO !l=0,PP_N
END DO; END DO; END DO ! i,j,k
...
Bhat = 0.25*dot_product(metric_L+metric_R,UL(IB1:IB3)+UR(IB1:IB3))
